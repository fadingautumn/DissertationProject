...
def load():
    with open(file="C:\\Users\\zen15\\Desktop\\DissProg\\lemmas.dat", mode='rb') as f:
        lemmas = pickle.loads(f.read())
    with open(file="C:\\Users\\zen15\\Desktop\\DissProg\\wordforms.dat", mode='rb') as f:
...
f = open("C:\\Users\\zen15\\Desktop\\DissProg\\oneg1.txt", mode='r', encoding='utf-8')
text = f.read()
f.close()

res = accentuate(text, wordforms, lemmas) 

f = open("C:\\Users\\zen15\\Desktop\\DissProg\\testcham.txt", mode='w', encoding='utf-8')
f.write(res)
f.close()
